...
namespace ecommapp.Services
{
    public class OrderItemRepository : IOrderItemRepository
    {
       ...
       public OrderItemRepository(AppDbContext context)
       {
        ...
        public async Task<IEnumerable<OrderItemDto>> GetOrderItemsAsync(int orderId, int skip, int take)
        {
     ...
     //   public async Task<IEnumerable<OrderDto>> GetOrderItemsAsync(int orderId, int skip, int take)
     //   {
     //        return await _context.OrderItems
     //            .Where(i => i.OrderId == orderId)
     //            .Skip(skip)
